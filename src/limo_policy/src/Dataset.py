...
class ActionRecorder:
    ...
    def cmd_vel_callback(self, msg):
        if msg.linear:
            ...
            linear_speed = self.line_speed
            angular_speed = self.yaw_speed
